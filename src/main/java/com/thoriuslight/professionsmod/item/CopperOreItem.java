...
public class CopperOreItem extends BlockItem implements IForgeable{

	public CopperOreItem(Block blockIn, Properties builder) {
	...
	public ItemStack forged(ItemStack stack) {
		return new ItemStack(ItemInit.COPPER_CHUNK.get(), 8);
	}
